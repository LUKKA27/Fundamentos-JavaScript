class Cuenta {
	...
	tasaIntahorro(_saldo, _tasaInteres){
		if (this._saldo >= 500000) {
			return this._tasaInteres + 0.01
		} else {
...
const cuen3= new Ahorro (2003,450000,7777,0.03)
console.log(cuen3)
// cuen3.saldo=500000
...
console.log(cuen3.tasaIntahorro());
